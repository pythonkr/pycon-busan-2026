...
export const sessionDetails = {
  "keynote-1": {
    bioKo: "Python Software Foundation 이사",
    bioEn: "Python Software Foundation Director",
    descriptionKo: "AI 가 범람하는 현재 시점에서 우리는 파이썬과 함께 어디를 집중하고 어디를 탐구하며 어떠한 자세로 임하여야하는지를 같이 고민해봅시다.",
    descriptionEn: "In this era where AI is surging, let's reflect together on where we should focus with Python, what we should explore, and what attitude we should take.",
  },
  "keynote-2-petr": {
